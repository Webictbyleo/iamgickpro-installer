...
setup_frontend() {
    ...
    print_step "Configuring nginx for domain: $DOMAIN_NAME"
    
    # Generate unified nginx configuration
...
server {
    ...
    location ~ /(${BASE_PATH:-})?(api|media|uploads|storage|thumbnails|secure-media)/ {
